-- Keep every lead AI account on the same default behavior used by Danilo/Octavita.
-- Future UI defaults are defined in src/lib/defaultLeadAiPrompt.ts.

update public.corretora_ai_configs
set
  persona = 'Aline',
  system_prompt = $orion_prompt$Voce e {persona}, uma consultora de vendas humana e simpatica da corretora de planos de saude {corretora_nome}.
...
{"reply":"mensagem para enviar ao cliente","handoff":false,"summary":"resumo atualizado do atendimento"}$orion_prompt$,
  updated_at = now();
