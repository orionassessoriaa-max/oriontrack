...
export default function CorretorTeamManager({ corretorId }: CorretorTeamManagerProps) {
  ...
  async function deleteTeam() {
    const confirmed = await confirmDialog(
      'Tem certeza de que deseja EXCLUIR COMPLETAMENTE este time comercial? Todos os integrantes cadastrados perderão o acesso ao Orion Track e as oportunidades voltarão para a carteira geral sem responsável. Esta ação é irreversível!',
      {
        ...
        <div className="rounded-[2.5rem] border border-white/5 bg-[#090e1a]/85 backdrop-blur-md p-8 md:p-12 shadow-2xl text-center space-y-8 relative overflow-hidden">
          ...
          <div className="max-w-2xl mx-auto space-y-4">
            ...
            <p className="text-sm font-medium text-slate-400 leading-relaxed">
              ...
              Cadastre integrantes, dê acessos exclusivos para cada vendedor e deixe o Orion Track distribuir os leads
                ...
                <div className="space-y-2">
                  ...
                  <div className="pl-9">
                    <p className="rounded-xl border border-white/5 bg-white/[0.02] p-3 text-[10px] font-bold text-slate-400">
                      O nome do time acompanha a concessionária vinculada no cadastro do admin.
                    </p>
                  </div>
                </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4 pt-2">
              ...
              <div className="bg-white/[0.02] border border-white/5 p-4 rounded-2xl">
                ...
                <p className="text-[11px] text-slate-400 font-medium leading-relaxed">
                  Como líder, você tem total controle. Pode direcionar ou transferir qualquer cliente da concessionária diretamente para um sócio ou corretor específico a qualquer momento.
                </p>
              </div>
            </div>
          </div>
                  ...
                  <div className="mb-3 flex items-center justify-between gap-3">
                    ...
                    <div className="text-right">
                      ...
                      <span className="text-[9px] font-black uppercase tracking-widest text-slate-500">
                        {member.participa_rodizio !== false ? 'no rodízio' : 'fora'}
                      </span>
                    </div>
                  </div>
          ...
          <div>
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-slate-400">Configure a escala de atendimento da concessionária.</p>
              </div>
            </div>
            ...
            <div className="mb-4">
              <div className="rounded-2xl border border-white/5 bg-[#070b13] px-5 py-4">
                <span className="mb-2 block text-[10px] font-black uppercase tracking-widest text-slate-500">Concessionária do time</span>
                <p className="text-sm font-black text-white">{displayTeamName}</p>
                <p className="mt-1 text-[10px] font-bold text-slate-500">Alterações de nome devem ser feitas no cadastro do corretor pelo admin.</p>
              </div>
            </div>
                ...
                <div className="mt-4 rounded-2xl border border-blue-500/15 bg-blue-500/5 p-5 animate-in fade-in slide-in-from-top-2 duration-300 space-y-5">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-1 text-[11px] font-bold leading-relaxed text-slate-400">
                        Defina quem recebe aviso quando o rodízio escolher um responsável. Ideal para separar sociedades entre admins e times com integrantes.
                      </p>
                      <select
                      ...
                      >
                        <option value="responsavel_e_admin_se_integrante" className="bg-[#070b13]">Responsável + admins somente se for integrante</option>
                        <option value="responsavel_apenas" className="bg-[#070b13]">Somente quem recebeu o lead</option>
                        <option value="responsavel_e_admins" className="bg-[#070b13]">Responsável + todos os admins</option>
                      </select>
                    </div>
                  </div>

                  <div className="h-px bg-white/5" />
                  {/* Distribution Toggle Option 2: RANDOMIZAÇÃO ATIVA */}
                  <div className="flex items-start gap-4">
                    <div className="mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#070b13] text-cyan-400 border border-white/5">
                      <Send size={18} />
                    </div>
                  ...
                  <div className="space-y-3">
                    <div>
                      <p className="font-black text-white text-sm">Rodízio da concessionária</p>
                      <p className="mt-1 text-[11px] font-bold leading-relaxed text-slate-400">
                        Escolha quem participa da contagem. Admins podem ver tudo mesmo quando estiverem fora do rodízio.
                      </p>
                    </div>
                    <div className="space-y-2">
                      {memberStats.map((member) => (
                        <div key={member.id} className="flex items-center justify-between gap-3 rounded-2xl border border-white/5 bg-[#070b13] px-4 py-3">
                          <div className="min-w-0">
                            ...
                            <p className="text-[10px] font-bold text-slate-500">
                              {member.tipo_usuario === 'corretor_admin' ? 'Sócio/Admin' : 'Corretor'} | {member.totalLeads} leads recebidos
                            </p>
                          </div>
                          <label className="relative inline-flex cursor-pointer items-center shrink-0">
                            <input
