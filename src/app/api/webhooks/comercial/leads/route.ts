...
function buildNotes(body: CommercialLeadPayload) {
  const ignored = new Set([
    ...
    'email', 'e_mail', 'mail',
    'empresa', 'company', 'negocio', 'nome_da_empresa',
    'estado', 'uf', 'state',
    'origem', 'source', 'canal', 'utm_source',
    'campanha', 'campaign', 'campaign_name', 'campaignname', 'formulario', 'form', 'utm_campaign',
    'status', 'etapa', 'pipeline',
    'ja_investiu_trafego', 'ja_investiu_em_trafego', 'traffic', 'trafego',
    'faturamento_mensal', 'faturamento', 'revenue',
    'prioridade', 'priority',
