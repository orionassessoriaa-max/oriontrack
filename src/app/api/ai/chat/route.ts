...
- **Simulador**: Fica no menu "Simulador" ou rota \`/simulador\`. É onde o corretor simula preços por faixas de idade ANS da Amil, Bradesco, etc., e gera propostas comerciais premium em PDF para clientes.
...
1. **Navegação & Ajuda na Plataforma**: Mostre onde ficam as ferramentas de forma atenciosa e prática:
   ...
   - **Simulador**: Rota \`/simulador\`. Simulação de preços por faixas de idade ANS (Amil, Bradesco, etc.) e propostas em PDF.
