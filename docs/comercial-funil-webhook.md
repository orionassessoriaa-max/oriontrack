...
## Notificacoes individuais de leads no WhatsApp

Depois que o rodizio define o responsavel, o Apolo envia os dados completos do
lead diretamente ao WhatsApp cadastrado da Talita ou do Carlos Eduardo (Kadu).
O grupo de leads nao participa mais desse fluxo.

### Rodizio automatico

Todos os novos leads, inclusive MQL S, recebem responsavel na entrada. A funcao
atomica `assign_next_commercial_sdr` alterna entre Talita e Carlos Eduardo (Kadu):
um lead para cada. Nao existe fila de disputa nem botao START neste fluxo.
